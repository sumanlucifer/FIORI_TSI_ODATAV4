		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comknpltsiusermanagement-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpltsiusermanagement-display": {
								"semanticObject": "comknpltsiusermanagement",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.tsi.usermanagement",
									"url": sap.ui.require.toUrl("com/knpl/tsi/usermanagement")
								}
							}
						}
					}
