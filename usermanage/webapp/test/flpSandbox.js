		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comknpltsiusermanagementusermanage-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comknpltsiusermanagementusermanage-display": {
								"semanticObject": "comknpltsiusermanagementusermanage",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.knpl.tsi.usermanagement.usermanage",
									"url": sap.ui.require.toUrl("com/knpl/tsi/usermanagement/usermanage")
								}
							}
						}
					}
